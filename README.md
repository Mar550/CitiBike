...
CITIBIKE is a dynamic e-commerce web application created with React JS, Node JS and Express JS. The app presents all  basic functionalities of an e-commerce website, and is built around the topic of e-bikes accessories.
